...
switch($_GET['data'])
{
	case 'talents':
		...
		// n - название (spellname из aowow_spell дл€ spellID=rank1)
		// m - кол-во ранков (6-количество_пустых_ранков)
		// s - спеллы дл€ ранков (rank1, rank2, ..., rank5 из aowow_talent)
		// d - описани€ спеллов
		// x - столбец (col из aowow_talent)
		// y - строка (row из aowow_talent)
		// r - от чего и какого ранка зависит: "r: [r_1, r_2]", где r_1 - номер (нумераци€ с 0) таланта, r_2 - ранк
		...
		if(!$p_arr = load_cache(20, $class))
		{
			...
			// ¬се "“абы" талантов заданного класса
			$tabs = $DB->select('
